...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/sinabs-exodus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sinabs-exodus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add sinabs-exodus
# for installing globally
pixi global install sinabs-exodus
```
...
It is possible to list all of the versions of `sinabs-exodus` available on your platform:
...
```
pixi search sinabs-exodus --channel conda-forge
```
